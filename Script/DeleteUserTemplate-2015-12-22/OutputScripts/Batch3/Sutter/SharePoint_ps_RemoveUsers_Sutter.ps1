$sitecollection = "https://ra.kisp.com/sutterhealth"

$prefix = "sutterhealth_"
$arrayLoginNames = 'sutterhealth_SUTTER', 'sutterhealth_MosaicDemo', 'sutterhealth_Mosaic', 'sutterhealth_System'
