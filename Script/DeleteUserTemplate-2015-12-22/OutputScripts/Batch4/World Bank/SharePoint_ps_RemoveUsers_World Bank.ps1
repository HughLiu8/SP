$sitecollection = "https://ra.kisp.com/WorldBankMosaic"

$prefix = "WorldBankMosaic_"
$arrayLoginNames = 'WorldBankMosaic_worldbank', 'WorldBankMosaic_Mosaic', 'WorldBankMosaic_System'
